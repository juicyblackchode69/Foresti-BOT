...
def callback(message):
    ...
    bot.send_message(message.chat.id, 'Если у вас возникли проблемы, напишите на почту:\********** или же напишите [сюда](https://t.me/*******)', parse_mode='markdown', disable_web_page_preview=True)
################################################################################################
###                                      FUNC CREATOR                                        ###
################################################################################################
def creator(message):
